...
// Standalone Serverless-Compatible Swagger UI Handler with Fredoka Font & Dark Theme
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    code, pre, .swagger-ui code, .swagger-ui pre, .swagger-ui .code, .swagger-ui .curl, .swagger-ui .microlight {
